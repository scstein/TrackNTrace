...
% Jean-Yves Tinevez < jeanyves.tinevez@gmail.com> November 2011 - 2012
    ...
    p.addParamValue('AutoLinkingDistance', default_auto_linking, @islogical);
    ...
    auto_linking_distance = p.Results.AutoLinkingDistance;
...
%     h_wait = waitbar(0,'Frame to Frame linking..');
    for i = 1 : n_slices-1
%         fprintf('Linking Frame %d of %d\n',i,n_slices-1)
        ...
        % By Simon
        if(auto_linking_distance)
            max_linking_distance = compute_linking_distance(source, target);
        end
