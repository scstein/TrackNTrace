...
trajParam.trajMaxLength = inf; %integer, maximum allowed length for trajectory
trajParam.frameMaxDistance = 6.5; %double, maximum distance a molecule travels in pixels per frame
trajParam.diffusionGuess = 0.0; %double, minimum sqrt(MSD) of trajectory
