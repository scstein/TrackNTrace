...
candidateOptions.intensityThreshold = 5; %double [0,100), only top X% of pixel intensity values are considered as candidates. Lower means fewer but better candiates
