...
\item [Linking Method] Only applies to \CC tracker, determines greediness of algorithm. Nearest-neighbor linking is more efficient but less accurate than Hungarian linking.
