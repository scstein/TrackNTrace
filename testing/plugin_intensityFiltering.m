...
%    -------------- User definition of plugin --------------
    ...
    add_param('particle_radius',...
              'int',...
              {3, 0, inf},...
              'Approximate spot radius');
    add_param('threshold_relative',...
              'float',...
              {5.2, 0, inf},...
              'Relative intensity threshold in percent. Example: 4 means only spots with intensity in the top 4% count.');
    add_param('pval_min',...
              'float',...
              {0.05, 0, inf},...
              'P value for significance test of signal against background. Between 0 and 1, lower means higher quality spots.');
    add_param('iteration_count',...
              'int',...
              {10, 0, inf},...
