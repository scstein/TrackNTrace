...
%
% INPUT:
%     posFilename: Can be string to TNG MAT file or fitData cell array
...
%main input is fitData cell array containing 1 cell per frame with 6 columns for x,y,amp,bckground,sigma,exitflag, N_max lines (N_max maximum overall number of candidates in any frame)
